...
\includegraphics[width=CHGHT\linewidth,height=CWDTH\linewidth,angle=0]{{OBJNAME-cbar}.png}
\end{center}
\caption{OBJNAME. Three-dimensional visualisation performed with the {\tt S2PLOT}
programming library (Barnes et al. 2006), using {\tt s2fits} (Fluke \& Barnes, {\em in prep}).}
\end{figure}
...
prepared with {\tt pdflatex}.  


All components required for recreating this PDF document are in the DIR\-OBJNAME
directory.  Running the {\tt package.csh} script again will remove any files, including
